...
import org.jetbrains.kotlin.types.checker.TypeCheckerRunner
...
sealed class KotlinType : Annotated {
    ...
    final override fun equals(other: Any?): Boolean {
        ...
        return isMarkedNullable == other.isMarkedNullable && TypeCheckerRunner.strictlyEqualsTypes(this, other)
    }
}
