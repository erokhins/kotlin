...
class TypeTemplate(val typeDescriptor: TypeParameterDescriptor) : FlexibleType(typeDescriptor.builtIns.nothingType, typeDescriptor.builtIns.nullableAnyType) {
    ...
    override fun render(renderer: DescriptorRenderer, options: DescriptorRendererOptions) =
        "~${renderer.renderType(typeDescriptor.defaultType)}"
}