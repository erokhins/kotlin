...
internal fun genPropertyForWidget(
    ...
    val type = classDescriptor?.let {
        ...
        if (defaultType.constructor.parameters.isEmpty())
            ...
            KotlinTypeFactory.create(Annotations.EMPTY, classDescriptor, false,
...
private fun genProperty(
    ...
    val flexibleType = KotlinTypeFactory.createFlexibleType(type as SimpleType, type.markNullableAsSpecified(true))
    property.setType(
            flexibleType,
