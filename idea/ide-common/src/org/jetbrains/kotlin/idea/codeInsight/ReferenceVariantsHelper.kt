...
public class ReferenceVariantsHelper(
    ...
    private fun getVariantsForUserType(explicitReceiverData: ExplicitReceiverData?, expression: JetSimpleNameExpression, kindFilter: DescriptorKindFilter, nameFilter: (Name) -> Boolean): Collection<DeclarationDescriptor> {
        ...
        return lexicalScope.getDescriptorsFiltered(kindFilter.restrictedToKinds(DescriptorKindFilter.CLASSIFIERS_MASK or DescriptorKindFilter.PACKAGES_MASK), nameFilter)
    }
    ...
    private fun getVariantsForImportOrPackageDirective(
        ...
        if (explicitReceiverData?.expression != null) {
