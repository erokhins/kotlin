...
class InvokeTowerProcessor<F : Candidate<FunctionDescriptor>, V : Candidate<VariableDescriptor>>(
        ...
        ResolutionKind.VariableAndObject.createTowerProcessor(scopeTower, explicitReceiver, name, factoryProviderForInvoke.factoryForVariable(stripExplicitReceiver = false))
) {
...
class InvokeExtensionTowerProcessor<F : Candidate<FunctionDescriptor>, V : Candidate<VariableDescriptor>>(
        ...
        factoryProviderForInvoke,
        ResolutionKind.VariableAndObject.createTowerProcessor(scopeTower, null, name, factoryProviderForInvoke.factoryForVariable(stripExplicitReceiver = true))
) {
