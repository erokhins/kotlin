...
public class QualifiedExpressionResolver(val symbolUsageValidator: SymbolUsageValidator) {
    ...
    public fun processImportReference(
        ...
        if (importDirective.isAllUnder) {
            ...
            val visibleDescriptors = descriptors.filter { !isInvisible(it, packageFragmentForVisibilityCheck, inImport = true) }.
                    check { it.isNotEmpty() } ?: return null
            return SingleImportScope(aliasName, visibleDescriptors)
        }
    }
