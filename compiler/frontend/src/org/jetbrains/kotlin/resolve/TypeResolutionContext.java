...
public class TypeResolutionContext {
    public final LexicalScopePart scope;
    public final BindingTrace trace;
    public final boolean checkBounds;
    public final boolean allowBareTypes;
    public final boolean forceResolveLazyTypes;

    public TypeResolutionContext(@NotNull LexicalScopePart scope, @NotNull BindingTrace trace, boolean checkBounds, boolean allowBareTypes) {
