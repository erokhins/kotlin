...
abstract class PSILambdaKotlinCallArgument(
...
) : PSILambdaKotlinCallArgument(outerCallContext, valueArgument, dataFlowInfoBeforeThisArgument, argumentName) {
...
) : FunctionExpression, PSILambdaKotlinCallArgument(outerCallContext, valueArgument, dataFlowInfoBeforeThisArgument, argumentName) {
...
internal fun KotlinCallArgument.setResultDataFlowInfoIfRelevant(resultDataFlowInfo: DataFlowInfo) {
    if (this is PSILambdaKotlinCallArgument) {
