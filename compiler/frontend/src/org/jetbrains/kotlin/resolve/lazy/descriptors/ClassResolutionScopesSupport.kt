...
class ClassResolutionScopesSupport(
        ...
        private val getOuterScope: () -> LexicalScopePart
) {
    ...
    fun getScopeForClassHeaderResolution(): LexicalScopePart = scopeForClassHeaderResolution()

    fun getScopeForMemberDeclarationResolution(): LexicalScopePart = scopeForMemberDeclarationResolution()

    private fun computeScopeForClassHeaderResolution(): LexicalScopePart {
        ...
        return ChainedScope(classDescriptor, "ScopeForClassHeaderResolution: " + classDescriptor.getName(), scope, getOuterScope().asJetScope()).asLocalScope() // todo remove? ChainedScope
    }

    private fun computeScopeForMemberDeclarationResolution(): LexicalScopePart {
        ...
        return ChainedScope(
                ...
                classDescriptor.getStaticScope()).asLocalScope() // todo
    }
