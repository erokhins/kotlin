...
public final class UsageTracker {
    ...
    public JsExpression getAliasForExpression(@NotNull JetReferenceExpression expression, @NotNull BindingContext bindingContext) {
        ...
        if (aliasNotExist(descriptor)) {
            ...
            return descriptorAliasConsumer.getAliasForExpression(expression, (CallableDescriptor) descriptor);
        }
    }
    ...
    public interface DescriptorAliasConsumer {
        ...
        @Nullable
        JsExpression getAliasForExpression(@NotNull JetReferenceExpression expression, @NotNull CallableDescriptor descriptor);
    }
}
