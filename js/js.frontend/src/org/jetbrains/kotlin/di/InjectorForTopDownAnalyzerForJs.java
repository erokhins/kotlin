...
public class InjectorForTopDownAnalyzerForJs {
    ...
    public InjectorForTopDownAnalyzerForJs(
        ...
        this.typeResolver = new TypeResolver(annotationResolver, qualifiedExpressionResolver, getModule(), flexibleTypeCapabilitiesProvider, storageManager, lazinessToken, dynamicTypesAllowed);
